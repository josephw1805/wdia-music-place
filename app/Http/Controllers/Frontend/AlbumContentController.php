...
class AlbumContentController extends Controller
{
    ...
    {
        $editMode = true;
        $chapter = AlbumChapter::where(['id' => $id, 'artist_id' => Auth::user()->id])->firstOrFail();
        return view('frontend.artist-dashboard.album.partials.album-chapter-modal', compact('chapter', 'editMode'))->render();
    }
    ...
    function createTrack(Request $request): string
    {
        ...
        return view('frontend.artist-dashboard.album.partials.chapter-track-modal', compact('albumId', 'chapterId'))->render();
    }
    ...
    function editTrack(Request $request): string
    {
        ...
        return view('frontend.artist-dashboard.album.partials.chapter-track-modal', compact('albumId', 'chapterId', 'track', 'editMode'))->render();
    }
    ...
    function sortChapter(string $id): string
    {
        ...
        return view('frontend.artist-dashboard.album.partials.album-chapter-sort-modal', compact('chapters'))->render();
    }
