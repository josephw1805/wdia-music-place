                    ...
                    <ul class="nav nav-pills instructor_det_tabs mt_50 wow fadeInUp" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-disabled-tab3" data-bs-toggle="pill"
                                data-bs-target="#pills-disabled3" type="button" role="tab"
                                aria-controls="pills-disabled3" aria-selected="false">Tours</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                            ...
                            <div class="instructor_details_courses">
                                <div class="row">
                                    @php
                                        $albums = App\Models\Album::where('is_approved', 'approved')
                                        ...
                                        @forelse ($albums as $album)
                                            <div class="wsus__single_courses_3">
                                                ...
                                                <div class="wsus__single_courses_text_3">
                                                    <div class="rating_area">
                                                        @php
                                                            ...
                                                            $subCategory = App\Models\AlbumCategory::where(
                                                                'id',
                                                                $categoryId,
                                                            )->first();
                                                            $cagetory = App\Models\AlbumCategory::where(
                                                                'id',
                                                                $subCategory->parent_id,
                                                            )->first();
                                                        @endphp
                                                        <p class="category">{{ $cagetory->name }}</p>
                                                        <a href="javascript:;"
                                                            class="category">{{ $subCategory->name }}</a>
                                                    </div>
                                                ...
                                                <div class="wsus__single_courses_3_footer">
                                                    <a class="common_btn" href="#">Subscribe <i
                                    ...
                                    <div class="col-xl-6">
                                        <div class="wsus__single_blog_4">
                                            ...
                                            <div class="wsus__single_blog_4_text">
                                                <ul>
                                                    <li>
                                                        <span><img src="images/user_icon_black.png" alt="User"
                                                                class="img-fluid"></span>
                                                        By Richard Tea
                                                    </li>
                                                    <li>
                                                        <span><img src="images/comment_icon_black.png" alt="Comment"
                                                                class="img-fluid"></span>
                                                        3 Comments
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="wsus__single_blog_4">
                                            ...
                                            <div class="wsus__single_blog_4_text">
                                                ...
                                                <a href="#" class="title">Uncovering Learning Opportunities in
                                                    Academia.</a>
                                                <p>Suspends dictum sed sem allium convallis Proin dictum ipsum.</p>
                                                <a href="#" class="common_btn">Read More <i
                                                        class="far fa-arrow-right"></i></a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="wsus__single_blog_4">
                                            ...
                                            <div class="wsus__single_blog_4_text">
                                                ...
                                                <a href="#" class="title">Internationally Distinguished Skillful
                                                    Educators.</a>
                                                <p>Suspends dictum sed sem allium convallis Proin dictum ipsum.</p>
                                                <a href="#" class="common_btn">Read More <i
                                                        class="far fa-arrow-right"></i></a>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6 col-lg-4">
                                        <div class="instructor_details_bagdes_item">
                                            <div class="img">
                                                <img src="{{ asset('frontend/assets/images/badge_1.png') }}" alt="Badges"
                                                    class="img-fluid">
                                            </div>
                                            <h4>CROWN</h4>
                                            <p>Metal</p>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-lg-4">
                                        <div class="instructor_details_bagdes_item">
                                            <div class="img">
                                                <img src="{{ asset('frontend/assets/images/badge_2.png') }}" alt="Badges"
                                                    class="img-fluid">
                                            </div>
                                            <h4>HEART</h4>
                                            <p>Fluff</p>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-lg-4">
                                        <div class="instructor_details_bagdes_item">
                                            <div class="img">
                                                <img src="{{ asset('frontend/assets/images/badge_3.png') }}" alt="Badges"
                                                    class="img-fluid">
                                            </div>
                                            <h4>SUGAR</h4>
                                            <p>Gummy</p>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-lg-4">
                                        <div class="instructor_details_bagdes_item">
                                            <div class="img">
                                                <img src="{{ asset('frontend/assets/images/badge_4.png') }}" alt="Badges"
                                                    class="img-fluid">
                                            </div>
                                            <h4>EARTH</h4>
                                            <p>Translucent</p>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-lg-4">
                                        <div class="instructor_details_bagdes_item">
                                            <div class="img">
                                                <img src="{{ asset('frontend/assets/images/badge_5.png') }}" alt="Badges"
                                                    class="img-fluid">
                                            </div>
                                            <h4>DRAGON</h4>
                                            <p>Alien</p>
