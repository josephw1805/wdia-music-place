...
const basic_info_url = base_url + '/admin/albums/create';
const update_url = base_url + '/admin/albums/update';
...
function updateApproveStatus(id, status) {
    $.ajax({
        method: 'PUT',
        url: base_url + `/admin/albums/${id}/update-approval`,
        data: {
            _token: csrf_token,
            status: status
        },
...
$('.dynamic-modal-btn').on('click', function () {
    ...
    $.ajax({
        method: 'GET',
        url: base_url + '/admin/album-content/:id/create-chapter'.replace(':id', album_id),
        data: {},
        beforeSend: function () {
...
$('.edit_chapter').on('click', function () {
    ...
    $.ajax({
        method: 'GET',
        url: base_url + '/admin/album-content/:id/edit-chapter'.replace(':id', chapter_id),
        data: {},
        beforeSend: function () {
            $('.dynamic-modal-content').html(loader);
        },
...
$('.add_track').on('click', function () {
    ...
    $.ajax({
        method: 'GET',
        url: base_url + '/admin/album-content/create-track',
        data: {
            'album_id': albumId,
...
$('.edit_track').on('click', function () {
    ...
    $.ajax({
        method: 'GET',
        url: base_url + '/admin/album-content/edit-track',
        data: {
            'album_id': albumId,
            'chapter_id': chapterId,
            'track_id': trackId
...
if ($('.sortable_list').length) {
    $('.sortable_list').sortable({
        ...
        update: function (event, ui) {
            ...
            $.ajax({
                method: 'POST',
                url: base_url + `/admin/album-content/${chapterId}/sort-track`,
                data: {
                    _token: csrf_token,
                    order_ids: orderId
                },
...
$('.sort_chapter_btn').on('click', function () {
    ...
    $.ajax({
        method: 'GET',
        url: base_url + `/admin/album-content/${albumId}/sort-chapter`,
        data: {
        },
        beforeSend: function () {
            $('.dynamic-modal-content').html(loader);
